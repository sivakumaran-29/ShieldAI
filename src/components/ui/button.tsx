  ...
  "inline-flex shrink-0 items-center justify-center whitespace-nowrap outline-none select-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        outline: "bg-panel backdrop-blur-[16px] hover:bg-[#3f6ad5] border border-divider text-white font-medium h-[52px] px-6 rounded-[20px] cursor-pointer transition-all duration-300 hover:shadow-[0_0_15px_rgba(63,106,213,0.6)] active:scale-[0.98] active:shadow-[0_0_8px_rgba(63,106,213,0.4)]",
        secondary: "bg-panel backdrop-blur-[16px] hover:bg-[#3f6ad5] border border-divider text-white font-medium h-[52px] px-6 rounded-[20px] cursor-pointer transition-all duration-300 hover:shadow-[0_0_15px_rgba(63,106,213,0.6)] active:scale-[0.98] active:shadow-[0_0_8px_rgba(63,106,213,0.4)]",
